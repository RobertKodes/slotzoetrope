...
export function poseSvg(pose: number, fill: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><g fill="${fill}" stroke="${fill}">${POSES[pose % POSES.length]}</g></svg>`;
}
